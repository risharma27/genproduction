...
# with command line options: Configuration/GenProduction/python/myfragment.py --filein file:../../cmsgrid_final.lhe --fileout file:VLLD_ele_M100_GENSIM.root --eventcontent RAWSIM --datatier GEN-SIM --beamspot Realistic25ns13TeVEarly2018Collision --step GEN,SIM --python_filename cfg_1_GENSIM.py --era Run2_2018 --mc --geometry DB:Extended --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring --conditions 106X_upgrade2018_realistic_v15 -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/myfragment.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:VLLD_ele_M100_GENSIM.root'),
